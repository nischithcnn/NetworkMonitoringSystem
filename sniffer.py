...
# sudo scapy ---> It displays certain messages related to scap ,suppress all teh unwanted messages
...
# Asking the user for the number of packets to sniff
...
# For this example :ARP, BOOTP, ICMP
...
file_name = input("* Please enter name for log file: ")
